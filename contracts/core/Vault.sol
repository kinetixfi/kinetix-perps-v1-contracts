...
contract Vault is ReentrancyGuard, IVault {
    ...
    function getRedemptionAmount(address _token, uint256 _usdkAmount) public override view returns (uint256) {
    ...
    function getTargetUsdkAmount(address _token) public override view returns (uint256) {
    ...
    function _reduceCollateral(address _account, address _collateralToken, address _indexToken, uint256 _collateralDelta, uint256 _sizeDelta, bool _isLong) private returns (uint256, uint256) {
        ...
        // reduce the positions collateral by _collateralDelta
        ...
        // else deduct the fee from the positions collateral
